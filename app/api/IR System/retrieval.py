...
def run_retrieval(user_query):
    ...
    # Folder Path
    path = "/Users/vritant/Documents/Saarthi-IR-Project/Documents"
    ...
    def after_insert():
        ...
        top_files = []
        for doc in returned_docs:
            doc_num = int(doc[0][1:])  # removes 'd' prefix, e.g., 'd1' => 1
            filename = file_map[doc_num][doc_num - 1]  # 0-indexed inside list
